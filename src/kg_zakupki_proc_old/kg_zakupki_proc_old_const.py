...
PAGE_LINK = 'http://zakupki.gov.kg/popp/view/order/single_source_procurement.xhtml'

VIEWSTATE_KEY = 'javax.faces.ViewState'

DEFAULT_OFFSET = 0

J_IDT93 = "//tr/td[2]//@onclick"
J_IDT75 = "string(//div[@class='col-2 report-head']/input/@name)"

X_PATH_CONTRACT_NUMBER = "//tr/td[2]/a/text()"
X_PATH_PROCURING = "//tr/td[3]//text()"
